...
- Next / Versioning Automation Slice 1 - Release Automation Skeleton: queued
...
4. Start Versioning Automation Slice 1 from `ops/versioning-automation-thin-slices.md`.
