...
- Next / Versioning Automation Slice 0 - Policy and Human-in-Loop Baseline: queued
...
4. Start Versioning Automation Slice 0 from `ops/versioning-automation-thin-slices.md`.
