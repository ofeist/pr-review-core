...
- Next / Versioning Automation Slice 5 - Consumer Pinning and Upgrade Guidance: queued
...
4. Start Versioning Automation Slice 5 from `ops/versioning-automation-thin-slices.md`.
