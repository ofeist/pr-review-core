...
- Next / Versioning Automation Slice 4 - Version Consistency Guards: queued
...
4. Start Versioning Automation Slice 4 from `ops/versioning-automation-thin-slices.md`.
